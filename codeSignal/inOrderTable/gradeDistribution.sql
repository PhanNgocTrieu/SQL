/*
At the end of every semester your professor for 
"Introduction to Databases" saves the exam results of every student in a simple database system. 
...
BEGIN
    ...
    WHERE (Midterm1 * 0.5 + Midterm2 * 0.5) < Final 
    OR (Midterm1 * 0.25 + Midterm2 * 0.25 + Final * 0.5) < Final 
